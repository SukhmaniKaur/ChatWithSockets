 ...
 */
class CameraAttachment: NSObject{
    static let shared = CameraAttachment()
    ...
    //MARK: - Constants
    struct Constants {
        static let actionFileTypeHeading = "Choose Image"
    ...
    func showAttachmentActionSheet(vc: UIViewController) {
        currentVC = vc
        let actionSheet = UIAlertController(title: Constants.actionFileTypeHeading, message: "", preferredStyle: .actionSheet)
...
extension CameraAttachment: UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
extension CameraAttachment: UIDocumentMenuDelegate, UIDocumentPickerDelegate{
