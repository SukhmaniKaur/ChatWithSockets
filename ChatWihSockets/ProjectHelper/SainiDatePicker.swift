//
//  SainiDatePicker.swift
//  ShareCity
//
//  Created by App Knit on 04/06/19.
...
class RToolBar: UIView {
    ...
    open var toolbar: UIToolbar {
        ...
        let toolBarTitleItem = toolBarL.titleItem(text: "", font: UIFont(name: "Avenir Book", size: 15.0)!, color: UIColor.black)
...
//        return appDelegate?.window?.currentController
        let currentVC = UIApplication.shared.windows.first
        return currentVC?.topViewController()
    }
